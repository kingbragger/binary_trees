...
/**
 * binary_tree_levelorder - Goes thru binary tree
...
/**
 * levels_rec - Calls funct on all nodes at each level,
...
/**
 * append - Addzs new node at the end of linkedlist.
...
/**
 * free_list - IT Frees all nodes in linked list,
